...
const pinnedFallbackPackage = "github:sheepxux/SuperLoop#v2.0.0";
const expectedRuntimeVersion = pinnedFallbackPackage.split("#v").at(-1);
const candidates = [
  path.join(packageRoot, "bin", "loopctl.js"),
  path.join(process.cwd(), "node_modules", "@sheepxux", "superloop", "bin", "loopctl.js")
];
...
console.error("Source: https://github.com/sheepxux/SuperLoop");
process.exit(127);
...
function isLoopEngineeringRuntime(root) {
  try {
    ...
    return manifest.name === "@sheepxux/superloop"
